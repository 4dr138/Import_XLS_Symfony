...
class getMusicRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MusicRepository.php';

        return $container->privates['App\\Repository\\MusicRepository'] = new \App\Repository\MusicRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
